...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var response, showsApiData, shows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("TERM", term);
                    return [4 /*yield*/, axios_1.default.get(TV_MAZE_SEARCH_URL, { params: { q: term } })];
                case 1:
                    response = _a.sent();
                    showsApiData = response.data;
                    shows = showsApiData.map(function (item) {
                        var _a;
                        var show = item.show;
                        return {
                            id: show.id,
                            ...
                            image: (show.image ? (_a = show.image) === null || _a === void 0 ? void 0 : _a.original : TV_MAZE_LOGO_IMG)
                        };
                    });
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(TV_MAZE_EPISODES_URL, "/").concat(id, "/episodes"))];
                case 1:
                    response = _a.sent();
                    data = response.data;
                    console.log("episodes consolelog", data);
                    episodes = data.map(function (episode) {
                        console.log(episode);
                        return {
                            id: episode.id,
                            name: episode.name,
...
$showsList.on("click", "button", function handleEpisodesButton(evt) {
    return __awaiter(this, void 0, void 0, function () {
        var id;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = $(evt.target).closest("div.Show").data("showId");
                    return [4 /*yield*/, retrieveAndDisplayEpisodes(id)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
